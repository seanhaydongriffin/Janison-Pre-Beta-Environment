...
Local $app_name = "Janison Pre Beta Environment"
...
$storage_format = '<a href=\"https://janisoncls.atlassian.net/wiki/download/attachments/494207048/Janison%20Pre%20Beta%20Environment%20portable.exe\">Click to update page</a><br /><br />'
...
Local $deployment = _OctopusGetLatestTenantIdsDeploymentIdTaskIdCreatedForEnvironment("Environments-21")
...
for $subscription_num = 0 to (UBound($subscription_arr) - 1)
	...
	$ps_script_arr[1] = "Get-AzureRmResource -ResourceType 'Microsoft.Sql/servers' -ResourceGroupName '*-ALPHA*'"
...
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "495845841", "495747608", "Pre Beta (Alpha) Environment", $storage_format)
